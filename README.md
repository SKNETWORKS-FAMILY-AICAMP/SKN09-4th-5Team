...
> **🧪 테스트 완료:**  
> 본 프로젝트의 주요 기능에 대해 총 12개 항목의 테스트 케이스를 수립하고 검증하였으며,  이 중 11개 항목이 정상적으로 작동함을 확인했습니다.  
> **"TS05-03: 챗봇 응답 이미지의 올바른 출력"** 항목에서는 이슈가 발생하였으며, 해당 기능은 일부 유물에서만 작동한다는 사실을 확인하여 추후 보완 예정 입니다.
